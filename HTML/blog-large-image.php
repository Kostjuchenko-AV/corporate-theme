		...
		<?php include('includes/header.php'); ?>
			...
			<section class="title-bar">
				<div class="container">
					...
					<div class="row">
						<div class="col-md-12">
							<h2 class="title">Large Image Blog</h2>
						</div>
					</div>
				</div>
			</section>			
			...
			<div class="container blog">
				<div class="row">
					...
					<!--Begin Blog Large Image Section-->
					<div class="col-md-9">	
						<div class="post">
							<div class="row post-image">
								<div class="col-md-12">
									<img class="img-responsive" src="img/portfolio/portfolio-1-wide.jpg" alt="Off The Cliff">
								</div>
							</div>
						...
						<div class="post">
							<div class="row post-image">
								<div class="col-md-12">
									<img class="img-responsive" src="img/portfolio/portfolio-2-wide.jpg" alt="Off The Pines">
								</div>
							</div>
