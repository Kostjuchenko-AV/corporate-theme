		...
		<?php include('includes/header.php'); ?>
			...
			<section class="title-bar">
				<div class="container">
					...
					<div class="row">
						<div class="col-md-12">
							<h2 class="title">Single Project - Full Width</h2>
						</div>
					</div>
				</div>
			</section>			
			...
			<div class="container portfolio-single">
				...
				<div class="row">
					<div class="col-md-12">
						<h3 class="page-header">Recent <span>Work</span></h3>
					</div>	
				</div>	
			...
			<!--End Portfolio Single Full Section-->
			
		<?php include('includes/footer.php'); ?>
		<?php // echo '1'; file_put_contents('html/portfolio-single-full.html', ob_get_contents()); ?>
